...
import { fetchSessionDetail, fetchSessionRegistryRows } from "../api/inventory.api";
    ...
    <div className={styles.wrap}>
      ...
      {!loading && detail && (
        <article className={styles.sheet}>
          ...
          <p className={styles.docSubtitle}>Перечень объектов учёта по документу инвентаризации в системе</p>
          ...
          <div className={styles.metaGrid}>
            ...
            <div>
              <span className={styles.metaLabel}>Инициатор</span>
              <span className={styles.metaValue}>{detail.session.created_by || "—"}</span>
            </div>
            <div>
